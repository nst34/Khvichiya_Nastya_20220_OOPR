...
Программа позволяет создавать, сохранять, открывать и редактировать таблицы расширения .csv. Если пользователь ошибся при вводе, то при нажатии кнопки "Add" данные из строк удалены не будут, но выведется сообщение об ошибке. Если пользователь ввёл корректные данные, то они будут добавлены в таблицу.
